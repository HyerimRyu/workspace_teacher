...
public class ServerSender extends JFrame {
	...
	public ServerSender() {
		...
		//txttop.setForeground(Color.WHITE);
		...
		//txtmiddle.setForeground(Color.YELLOW);
		...
		//setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //서버가 껐다고해서 메인프레임이 꺼지면안됨
		setVisible(true);
